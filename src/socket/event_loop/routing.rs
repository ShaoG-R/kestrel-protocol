                ...
                if let Some(pending_frames) = self.pending_frames.remove(&cache_key) {
                    ...
                    for pending_frame in pending_frames {
                        ...
                        if pending_frame.remote_addr == remote_addr {
                            if meta
                                .sender
                                .send((pending_frame.frame.clone(), pending_frame.remote_addr))
                                .await
                                .is_ok()
                            {
                                forwarded_count += 1;
...
mod tests {
    ...
    async fn test_early_frame_caching() {
        ...
        let push_frame = Frame::new_push(
            ...
            1024,
            12345,
            bytes::Bytes::from_static(b"test data"),
        );
    ...
    async fn test_multiple_early_frames_caching() {
        ...
        let push_frame1 =
            Frame::new_push(cid, 0, 0, 1024, 12345, bytes::Bytes::from_static(b"data1"));
        let push_frame2 =
            Frame::new_push(cid, 1, 0, 1024, 12346, bytes::Bytes::from_static(b"data2"));
    ...
    async fn test_forward_cached_frames_success() {
        ...
        let push_frame = Frame::new_push(
            ...
            1024,
            12345,
            bytes::Bytes::from_static(b"cached data"),
        );
    ...
    async fn test_zero_rtt_early_frames_caching() {
        ...
        let push_frame = Frame::new_push(
            ...
            1024,
            12345,
            bytes::Bytes::from_static(b"0-RTT data"),
        );
        ...
        router
            .register_connection(actual_cid, remote_addr, meta)
            .await;
    ...
    async fn test_multiple_clients_zero_rtt_isolation() {
        ...
        let push_frame1 = Frame::new_push(
            0,
            0,
            0,
            1024,
            12345,
            bytes::Bytes::from_static(b"client1 data"),
        );
        let push_frame2 = Frame::new_push(
            0,
            1,
            0,
            1024,
            12346,
            bytes::Bytes::from_static(b"client2 data"),
        );
