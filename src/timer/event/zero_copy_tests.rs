...
mod tests {
    ...
    fn test_fast_event_slot_concurrent_writes() {
        ...
        println!("Concurrent writes: {} successes out of {} attempts", 
                 final_success_count, thread_count * writes_per_thread);
    ...
    fn test_zero_copy_batch_dispatcher_load_balancing() {
        ...
        println!("Dispatched {} out of 100 events in {:?}", dispatched_count, duration);
    ...
    fn test_memory_efficiency_no_cloning() {
        ...
        for i in 0..10 {
            ...
            println!("Iteration {}: dispatched {} out of {} events", i, dispatched_count, initial_len);
        ...
        println!("Memory efficiency test completed - total dispatched: {}", total_dispatched);
    }
    ...
    fn test_zero_copy_max_batch_size() {
        ...
        println!("Max batch: {} out of 10K events processed in {:?}", dispatched_count, duration);
